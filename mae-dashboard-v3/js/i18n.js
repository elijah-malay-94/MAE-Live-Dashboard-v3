...
(function () {
  ...
  const dict = {
    en: {
      ...
      'job.noDevices': 'No devices',
      'job.noAvailableDevices': 'No devices listed under Available — nothing to add with →.',
      'job.noAssociatedDevices': 'No devices associated — nothing to remove with ←.',
      'job.createdOk': 'Work created successfully.',
      'job.couldNotSave': 'Could not save work.',
      'job.saveBeforeStatus': 'Save the work before changing its status.',
      'job.couldNotUpdateStatus': 'Could not update work status.',
      'job.saveBeforeDevices': 'Save the work before associating devices.',
      'job.couldNotConnect': 'Could not connect device to work.',
      ...
      'nav.userManagement': 'Authorization Management',
      'nav.users': 'Users',

      'users.statTotal':         'Total Users',
      'users.statTotalSub':      '{total} registered accounts',
      'users.statEnabled':       'Enabled',
      'users.statEnabledSub':    '{enabled} active accounts',
      'users.statLocked':        'Locked',
      'users.statLockedSub':     '{locked} locked accounts',
      'users.btnCreate':         '+ Create User',
      'users.tableTitle':        'User List',
      'users.searchPlaceholder': 'Search by ID, email or username…',
      'users.colId':             'ID',
      'users.colEmail':          'Email',
      'users.colEnabled':        'Enabled',
      'users.colLocked':         'Locked',
      'users.colEmailVerified':  'Email Verified',
      'users.colLastLogin':      'Last Login',
      'users.colActions':        'Actions',
      'users.empty':             'No users found.',
      'users.loading':           'Loading…',
      'users.paginationInfo':    '{count} shown · {total} total',
      'users.editEmail':         'Edit Email',
      'users.viewDetails':       'View Details',
      'users.manageDevices':     'Manage Devices',
      'users.createTitle':       'Create New User',
      'users.fieldEmail':        'Email',
      'users.errEnterEmail':     'Please enter an email address.',
      ...
      'users.fieldLocked':               'Locked',
      'users.fieldEmailVerified':        'Email Verified',
      'users.fieldLastLogin':            'Last Login',
      'users.fieldLastAttempt':          'Last Attempt',
      'users.fieldFailedAttempts':       'Failed Attempts',
      'users.fieldResetToken':           'Reset Token',
      'users.fieldResetTokenExpires':    'Reset Token Expires',
      'users.fieldVerifyToken':          'Verify Token',
      'users.fieldVerifyTokenExpires':   'Verify Token Expires',
      'users.fieldRefreshToken':         'Refresh Token',
      'users.fieldRefreshTokenExpires':  'Refresh Token Expires',
      'users.fieldCreatedById':          'Created By',
      'users.fieldCreatedAt':            'Created At',
      'users.fieldUpdatedById':          'Updated By',
      'users.fieldUpdatedAt':            'Updated At',
      'users.errLoadFailed':     'Failed to load users.',
      'users.editEmailTitle':    'Edit Email Address',
      'users.newEmail':          'New Email',
      'users.currentPassword':   'Current Password',
      'users.errEnterPassword':  'Please enter your password.',
      'users.errUpdateFailed':   'Failed to update.',
      'users.successEmailUpdated': 'Email updated successfully.',
      'users.devicesTitle':      'User Devices',
      'users.devicesColId':      'ID',
      'users.devicesColType':    'Type',
      'users.devicesColSerial':  'Serial',
      'users.devicesColIp':      'IP',
      'users.devicesColEnabled': 'Enabled',
      'users.devicesEmpty':      'No devices found.',
      'users.addDeviceTitle':    'Add New Device',
      'users.fieldDeviceType':   'Device Type',
      'users.fieldSerial':       'Serial Number',
      'users.btnAddDevice':      '+ Add Device',
      'users.errEnterDeviceType':'Please enter a device type.',
      'users.errEnterSerial':    'Please enter a serial number.',
      'users.errDeviceFailed':   'Failed to add device.',
      'users.successDeviceAdded':'Device added successfully.',

      'um.statTotal':        'Total Authorizations',
      'um.statUsers':        'User Authorizations',
      'um.statTokens':       'Guest Authorizations',
      ...
      'um.sectionNewToken':  'New Guest Authorization',
      'um.badgeUserProfile': 'User + Profile',
      'um.badgeTokenAccess': 'Guest Access',
      ...
      'um.btnCreateToken':   '+ Create Guest Auth',
      'um.btnSaveChanges':   'Save Changes',
      'um.separator':        '— or create a guest authorization —',

      'um.listTitle':         'Authorization List',
      'um.searchPlaceholder': 'Search by work, user, guest, profile…',
      'um.filterAllTypes':    'All types',
      'um.filterUser':        'User',
      'um.filterToken':       'Guest',
      ...
      'um.successCreatedToken': 'Guest authorization created successfully.',
    ...
    it: {
      ...
      'works.edit': 'Modifica',
      'works.editWork': 'Modifica lavoro',
      ...
      'job.noDevices': 'Nessun dispositivo',
      'job.noAvailableDevices': 'Nessun dispositivo disponibile — niente da aggiungere con →.',
      'job.noAssociatedDevices': 'Nessun dispositivo associato — niente da rimuovere con ←.',
      'job.createdOk': 'Lavoro creato con successo.',
      'job.couldNotSave': 'Impossibile salvare il lavoro.',
      'job.saveBeforeStatus': 'Salva il lavoro prima di cambiare lo stato.',
      'job.couldNotUpdateStatus': 'Impossibile aggiornare lo stato del lavoro.',
      'job.saveBeforeDevices': 'Salva il lavoro prima di associare dispositivi.',
      'job.couldNotConnect': 'Impossibile collegare il dispositivo al lavoro.',
      ...
      'users.statTotal':         'Utenti totali',
      'users.statTotalSub':      '{total} account registrati',
      'users.statEnabled':       'Abilitati',
      'users.statEnabledSub':    '{enabled} account attivi',
      'users.statLocked':        'Bloccati',
      'users.statLockedSub':     '{locked} account bloccati',
      'users.btnCreate':         '+ Crea utente',
      'users.tableTitle':        'Elenco utenti',
      'users.searchPlaceholder': 'Cerca per ID, email o username…',
      'users.colId':             'ID',
      'users.colEmail':          'Email',
      'users.colEnabled':        'Abilitato',
      'users.colLocked':         'Bloccato',
      'users.colEmailVerified':  'Email verificata',
      'users.colLastLogin':      'Ultimo accesso',
      'users.colActions':        'Azioni',
      'users.empty':             'Nessun utente trovato.',
      'users.loading':           'Caricamento…',
      'users.paginationInfo':    '{count} mostrati · {total} totale',
      'users.editEmail':         'Modifica email',
      'users.viewDetails':       'Visualizza dettagli',
      'users.manageDevices':     'Gestisci dispositivi',
      'users.createTitle':       'Crea nuovo utente',
      'users.fieldEmail':        'Email',
      'users.errEnterEmail':     "Inserisci un indirizzo email.",
      'users.errCreateFailed':   'Creazione utente fallita.',
      'users.successCreated':    'Utente creato con successo.',
      'users.detailsTitle':      'Dettagli utente',
      'users.fieldId':                   'ID',
      'users.fieldEnabled':              'Abilitato',
      'users.fieldLocked':               'Bloccato',
      'users.fieldEmailVerified':        'Email verificata',
      'users.fieldLastLogin':            'Ultimo accesso',
      'users.fieldLastAttempt':          'Ultimo tentativo',
      'users.fieldFailedAttempts':       'Tentativi falliti',
      'users.fieldResetToken':           'Token di reset',
      'users.fieldResetTokenExpires':    'Scadenza token reset',
      'users.fieldVerifyToken':          'Token di verifica',
      'users.fieldVerifyTokenExpires':   'Scadenza token verifica',
      'users.fieldRefreshToken':         'Refresh token',
      'users.fieldRefreshTokenExpires':  'Scadenza refresh token',
      'users.fieldCreatedById':          'Creato da',
      'users.fieldCreatedAt':            'Creato il',
      'users.fieldUpdatedById':          'Aggiornato da',
      'users.fieldUpdatedAt':            'Aggiornato il',
      'users.errLoadFailed':     'Caricamento utenti fallito.',
      'users.editEmailTitle':    'Modifica indirizzo email',
      'users.newEmail':          'Nuova email',
      'users.currentPassword':   'Password attuale',
      'users.errEnterPassword':  'Inserisci la password.',
      'users.errUpdateFailed':   'Aggiornamento fallito.',
      'users.successEmailUpdated': 'Email aggiornata con successo.',
      'users.devicesTitle':      'Dispositivi utente',
      'users.devicesColId':      'ID',
      'users.devicesColType':    'Tipo',
      'users.devicesColSerial':  'Seriale',
      'users.devicesColIp':      'IP',
      'users.devicesColEnabled': 'Abilitato',
      'users.devicesEmpty':      'Nessun dispositivo trovato.',
      'users.addDeviceTitle':    'Aggiungi nuovo dispositivo',
      'users.fieldDeviceType':   'Tipo dispositivo',
      'users.fieldSerial':       'Numero seriale',
      'users.btnAddDevice':      '+ Aggiungi dispositivo',
      'users.errEnterDeviceType':'Inserisci il tipo di dispositivo.',
      'users.errEnterSerial':    'Inserisci il numero seriale.',
      'users.errDeviceFailed':   'Aggiunta dispositivo fallita.',
      'users.successDeviceAdded':'Dispositivo aggiunto con successo.',

      'um.statTotal':        'Autorizzazioni totali',
      'um.statUsers':        'Autorizzazioni utente',
      'um.statTokens':       'Autorizzazioni guest',
      ...
      'um.sectionNewToken':  'Nuova autorizzazione guest',
      'um.badgeUserProfile': 'Utente + Profilo',
      'um.badgeTokenAccess': 'Accesso guest',
      ...
      'um.btnCreateToken':   '+ Crea auth guest',
      'um.btnSaveChanges':   'Salva modifiche',
      'um.separator':        "— oppure crea un'autorizzazione guest —",

      'um.listTitle':         'Lista autorizzazioni',
      'um.searchPlaceholder': 'Cerca per lavoro, utente, guest, profilo…',
      ...
      'um.editTitleToken': 'Modifica autorizzazione — Guest',
      ...
      'um.statTokensSub':  '{tokens} chiavi di accesso API guest',
      ...
      'um.successCreatedToken': 'Autorizzazione guest creata con successo.',
  ...
  function applyLanguage(lang = getLanguage()) {
    ...
    // Users page: re-render stats and table so dynamic strings update.
    try {
      if (typeof window.getCurrentPage === 'function' && window.getCurrentPage() === 'users') {
        if (typeof window.renderUsersStats === 'function') window.renderUsersStats();
