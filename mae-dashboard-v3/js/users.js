  ...
  return `<tr>
    ...
    <td>
      <div class="us-email-cell">
        ...
        <button class="us-btn-edit-email" title="${editTitle}" onclick="usOpenEditEmail(${Number(u.id)}, ${JSON.stringify(_usEsc(u.email || ''))})">
    ...
    <td>
      <div class="us-actions-cell">
        ...
        <button class="us-btn-icon us-btn-icon--devices" title="${devTitle}" onclick="usOpenDevices(${Number(u.id)}, ${JSON.stringify(_usEsc(u.email || ''))})">
